...
namespace PrinterMonitoring.Controllers
{
    public class HMController : Controller
    {
        ...
        {
            if (log.PERIOD == null || log.JENIS_MESIN == "" || log.SITE == null || log.SITE == "" || log.DEPARTMENT == null || log.DEPARTMENT == "" ||
                log.PIC == null || log.PIC == "" || log.JENIS_MESIN == null || log.JUMLAH == null || log.JAM == null || log.HARI == null)
            {
